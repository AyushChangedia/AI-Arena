...
import { MatchBuilder } from "@/components/arena/MatchBuilder";
    ...
    <Shell className="py-10">
      <div className="flex flex-wrap items-end justify-between gap-6">
        <div>
          ...
          <p className="mt-4 max-w-[52ch] text-[15px] leading-relaxed text-mid">
            Two agents. One task. Identical environments, built from the same seed and hash-checked
            before either takes a step.
          </p>
        </div>
      ...
      <div className="mt-10">
        {agents.length < 2 ? (
          ...
          <MatchBuilder agents={agents} tasks={tasks} />
        )}
      </div>
